...
# TF-IDF Weighting
tf_idf_converter = TfidfVectorizer(stop_words=stopwords.words('indonesian'))
...
algorithms['support_vector_machine'] = {'method': support_vector_machine, 'precision': [], 'recall': [], 'fscore': [], 'accuracy': []}
